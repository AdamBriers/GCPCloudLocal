...
variable "create_sink" {
  description = "Indicates if should create the log sink or not"
  type        = bool
  default     = false
}
...
variable "bigquery_options" {
  default     = { use_partitioned_tables = true }
...
variable "bigquery_project" {
  description = "The target BigQuery project for the log sink"
  type        = string
}
