...
inputs = {
  ...
  project_members = [
    ...
    {
      project_iam_permissions = ["roles/bigquery.dataEditor", "roles/bigquery.jobUser", "roles/bigquery.dataOwner", "roles/bigquery.readSessionUser", "roles/storage.objectAdmin", "roles/compute.viewer"]
      member_type             = "group"
